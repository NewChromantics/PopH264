...
public class PopIsm : MonoBehaviour {
	...
	enum SmoothStreamTrackType
	{
		Video,
		Audio,
	}
	struct SmoothStreamSource //	"Quality Level"
	{
		public int Index;
		public int Bitrate;
	...
	SmoothStreamSource ParseTrackQualityLevel(XmlElement QualityLevelXml)
	{
	...
	SmoothStreamTrack ParseTrack(XmlElement StreamIndexXml)
	{
	...
	void ParseManifest(XmlNode SmoothStreamingMedia)
	{
	...
	void ParseManifest(string ManifestContents)
	{
		...
		try
		{
			...
			ParseManifest(SmoothStreamingMediaNodes[0]);
		}
